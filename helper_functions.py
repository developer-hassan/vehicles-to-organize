...
def process_xlsx_files(df, brand_data, df_family, model_data: pd.DataFrame, possible_brands: list, family_data):
    ...
    for index, row in df.iterrows():
        ...
        #     print(f"Extracted Year: {year}")
        #     print(f"Extracted Brand: {brand}")
        #     print(f"Extracted Family: {family_name}")
        #     print(f"Modified Description: {modified_description}\n")
        ...
        modello_b_versione_digits, modello_b_versione_strings = extract_digits_from_modello_b_versione(input_string=model_version_string)
        ...
        # modello_a_serie, id_record_model, mod_serie, mod_stage = extract_modello_a_serie(
        #     modified_description=modified_description,
        #     family_name=family_name, brand_name=brand, year=year, model_data=model_data, number_part=number_part)
